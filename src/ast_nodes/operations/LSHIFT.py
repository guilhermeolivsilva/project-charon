"""Representation of LSHIFT nodes for the Abstract Syntax Tree."""
...
class LSHIFT(Operation):
    """
    Implement the representation of a left shift operation (<<) for the AST.
